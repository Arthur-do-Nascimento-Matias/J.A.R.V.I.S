...
function CaseMode(){
    ...
    return(
        <>
            <button id="microfoneCase" onClick={() => toggleMicApertar(tipoMicrofone, setPergunta, modeloDeIA, player, chatRef, toastRef, true)}><img src={microfone} alt="" draggable="false" id="mic" /></button>
            <textarea id="perguntaCase" rows="3" cols="50" placeholder="Digite aqui..." onKeyDown={e => handleKeyPress(e, pergunta, setPergunta, modeloDeIA, player, chatRef, toastRef)} value={pergunta} onChange={e => setPergunta(e.target.value)}></textarea>
